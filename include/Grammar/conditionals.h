...
extern object create_condition_tree(const object& condition, object &operation);
extern void add_branch_to_tree(object &tree, const object& condition, object &operation);
extern void add_wildcard_to_tree(object &tree, object &operation);
